...
const explainations = {
    ...
    'testsNcasesNdiscardedNfindCol': { 'title': 'Pruebas procesadas, casos confirmados, casos descartados y pruebas procesadas reportadas por FIND acumuladas', 'text': 'En esta gráfica ahora también encontrarás, encima de las barras, unos cuadros blancos con la información de pruebas totales reportada por FIND. Pusimos este dato para contrastar los datos de cada una de las fuentes. También puedes ver unas fechas relevantes en la evolución de la administración de las pruebas en la parte inferior derecha.'},
