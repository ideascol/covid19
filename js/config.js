...
const explainations = {
    ...
    'intExamples': { 'title': 'Pruebas procesadas, casos confirmados y muertes', 'text': 'En esta gráfica encuentras el total de pruebas procesadas en negro, el total de casos confirmados en verde y el total de muertes en rojo. ¡Próximamente verás una versión interactiva de estas gráficas!' },
    'testsNcasesNdiscardedNfindCol': { 'title': 'Pruebas procesadas, casos confirmados, casos descartados y pruebas procesadas oficiales acumuladas', 'text': 'En esta gráfica ahora también encontrarás, encima de las barras, unos cuadros blancos con la información de pruebas totales reportada por FIND. Pusimos este dato para contrastar los datos de cada una de las fuentes. También puedes ver unas fechas relevantes en la evolución de la administración de las pruebas en la parte inferior derecha.'},
