...
const explainations = {
    ...
    'map': { 'title': 'Análisis por departamentos', 'text': 'En esta gráfica encontrarás los casos confirmados, las pruebas procesadas y las muertes por cada cien mil habitantes para cada departamento. La información reportada es la más actualizada. Si pones el cursor sobre las burbujas que están sobre cada departamento, podrás observar el dato correspondiente.' }
}